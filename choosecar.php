...
<html lang="en">
	...
	<body class="other">
		...
		<div class="container adjustnavpositon">
			<div class="row">
				<div class="col-md-9">
					<h3>Choose Cars from EZride Car Rental</h3>
				</div>
				<div class="col-md-3">
				...
				<div class="col-md-8 col-md-offset-1">
                  ...
                  # Paging
					...
					<div class="row car">
						...
						<div class="col-md-2">
							<p class="carcost"><i class="fa fa-money"></i> INR<?php echo $rowgetcars['carcost']; ?> per 6 Hours</p>
							<span style="color: #aff; text-align: center;"><i class="fa fa-money"></i> INR<?php echo $rowgetcars['carcost']/6 * $durationinhours; ?> for your duration</span>
							<hr>
